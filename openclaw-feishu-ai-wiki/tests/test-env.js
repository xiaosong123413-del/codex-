...
process.env.AI_WIKI_PAGE_ALL_PAGES ??= 'N1lzwE6UciGFOIkMH3Fcf66Gnkf';
process.env.AI_WIKI_PAGE_TIMELINE ??= 'Dq9rwWauLiLTxbky1bkch3rPnDb';
process.env.AI_WIKI_PAGE_MAINTENANCE_GUIDE ??= 'KpEawjD4ViIvmlkdXP0cAcmGn1c';
process.env.AI_WIKI_PAGE_INDEX_ROOT ??= 'E2GfwBUPQiGKKFkVDRsc8wtsnUj';

process.env.AI_WIKI_JOURNAL_MEMORY_ROOT ??= 'LNqCw1uVhin6TzkKPLAcDYyVnof';
process.env.AI_WIKI_JOURNAL_ENTRY_DEPTH ??= '1';
